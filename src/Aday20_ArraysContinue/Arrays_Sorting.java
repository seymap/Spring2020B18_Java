...
public class Arrays_Sorting {
    public static void main(String[] args) {
        ...
        int[] arrb = {3,1,4,-1,100, -100, 200, 155};
        int[] arrDescb = new int[arrb.length];  //[0, 0, 0, 0, 0, 0, 0, 0]
        ...
        for(int i = arrb.length-1; i >= 0; i-- ){
            arrDescb[k] =  arrb[i];
            k++;
            System.out.println(  Arrays.toString(arrDescb)  );
        }
